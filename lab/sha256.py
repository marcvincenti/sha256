...
def bool_e_1(x):
    return [
        (x[26] or x[21] or x[7]) and (x[26] or not x[21] or not x[7]) and (not x[26] or x[21] or not x[7]) and (not x[26] or not x[21] or x[7]),
        (x[27] or x[22] or x[8]) and (x[27] or not x[22] or not x[8]) and (not x[27] or x[22] or not x[8]) and (not x[27] or not x[22] or x[8]),
        (x[28] or x[23] or x[9]) and (x[28] or not x[23] or not x[9]) and (not x[28] or x[23] or not x[9]) and (not x[28] or not x[23] or x[9]),
        (x[29] or x[24] or x[10]) and (x[29] or not x[24] or not x[10]) and (not x[29] or x[24] or not x[10]) and (not x[29] or not x[24] or x[10]),
        (x[30] or x[25] or x[11]) and (x[30] or not x[25] or not x[11]) and (not x[30] or x[25] or not x[11]) and (not x[30] or not x[25] or x[11]),
        (x[31] or x[26] or x[12]) and (x[31] or not x[26] or not x[12]) and (not x[31] or x[26] or not x[12]) and (not x[31] or not x[26] or x[12]),
        (x[0] or x[27] or x[13]) and (x[0] or not x[27] or not x[13]) and (not x[0] or x[27] or not x[13]) and (not x[0] or not x[27] or x[13]),
        (x[1] or x[28] or x[14]) and (x[1] or not x[28] or not x[14]) and (not x[1] or x[28] or not x[14]) and (not x[1] or not x[28] or x[14]),
        (x[2] or x[29] or x[15]) and (x[2] or not x[29] or not x[15]) and (not x[2] or x[29] or not x[15]) and (not x[2] or not x[29] or x[15]),
        (x[3] or x[30] or x[16]) and (x[3] or not x[30] or not x[16]) and (not x[3] or x[30] or not x[16]) and (not x[3] or not x[30] or x[16]),
        (x[4] or x[31] or x[17]) and (x[4] or not x[31] or not x[17]) and (not x[4] or x[31] or not x[17]) and (not x[4] or not x[31] or x[17]),
        (x[5] or x[0] or x[18]) and (x[5] or not x[0] or not x[18]) and (not x[5] or x[0] or not x[18]) and (not x[5] or not x[0] or x[18]),
        (x[6] or x[1] or x[19]) and (x[6] or not x[1] or not x[19]) and (not x[6] or x[1] or not x[19]) and (not x[6] or not x[1] or x[19]),
        (x[7] or x[2] or x[20]) and (x[7] or not x[2] or not x[20]) and (not x[7] or x[2] or not x[20]) and (not x[7] or not x[2] or x[20]),
        (x[8] or x[3] or x[21]) and (x[8] or not x[3] or not x[21]) and (not x[8] or x[3] or not x[21]) and (not x[8] or not x[3] or x[21]),
        (x[9] or x[4] or x[22]) and (x[9] or not x[4] or not x[22]) and (not x[9] or x[4] or not x[22]) and (not x[9] or not x[4] or x[22]),
        (x[10] or x[5] or x[23]) and (x[10] or not x[5] or not x[23]) and (not x[10] or x[5] or not x[23]) and (not x[10] or not x[5] or x[23]),
        (x[11] or x[6] or x[24]) and (x[11] or not x[6] or not x[24]) and (not x[11] or x[6] or not x[24]) and (not x[11] or not x[6] or x[24]),
        (x[12] or x[7] or x[25]) and (x[12] or not x[7] or not x[25]) and (not x[12] or x[7] or not x[25]) and (not x[12] or not x[7] or x[25]),
        (x[13] or x[8] or x[26]) and (x[13] or not x[8] or not x[26]) and (not x[13] or x[8] or not x[26]) and (not x[13] or not x[8] or x[26]),
        (x[14] or x[9] or x[27]) and (x[14] or not x[9] or not x[27]) and (not x[14] or x[9] or not x[27]) and (not x[14] or not x[9] or x[27]),
        (x[15] or x[10] or x[28]) and (x[15] or not x[10] or not x[28]) and (not x[15] or x[10] or not x[28]) and (not x[15] or not x[10] or x[28]),
        (x[16] or x[11] or x[29]) and (x[16] or not x[11] or not x[29]) and (not x[16] or x[11] or not x[29]) and (not x[16] or not x[11] or x[29]),
        (x[17] or x[12] or x[30]) and (x[17] or not x[12] or not x[30]) and (not x[17] or x[12] or not x[30]) and (not x[17] or not x[12] or x[30]),
        (x[18] or x[13] or x[31]) and (x[18] or not x[13] or not x[31]) and (not x[18] or x[13] or not x[31]) and (not x[18] or not x[13] or x[31]),
        (x[19] or x[14] or x[0]) and (x[19] or not x[14] or not x[0]) and (not x[19] or x[14] or not x[0]) and (not x[19] or not x[14] or x[0]),
        (x[20] or x[15] or x[1]) and (x[20] or not x[15] or not x[1]) and (not x[20] or x[15] or not x[1]) and (not x[20] or not x[15] or x[1]),
        (x[21] or x[16] or x[2]) and (x[21] or not x[16] or not x[2]) and (not x[21] or x[16] or not x[2]) and (not x[21] or not x[16] or x[2]),
        (x[22] or x[17] or x[3]) and (x[22] or not x[17] or not x[3]) and (not x[22] or x[17] or not x[3]) and (not x[22] or not x[17] or x[3]),
        (x[23] or x[18] or x[4]) and (x[23] or not x[18] or not x[4]) and (not x[23] or x[18] or not x[4]) and (not x[23] or not x[18] or x[4]),
        (x[24] or x[19] or x[5]) and (x[24] or not x[19] or not x[5]) and (not x[24] or x[19] or not x[5]) and (not x[24] or not x[19] or x[5]),
        (x[25] or x[20] or x[6]) and (x[25] or not x[20] or not x[6]) and (not x[25] or x[20] or not x[6]) and (not x[25] or not x[20] or x[6])
    ]

def bool_Ch(x, y, z):
    return [
        (x[0] or z[0]) and (not x[0] or y[0]) and (y[0] or z[0]),
        (x[1] or z[1]) and (not x[1] or y[1]) and (y[1] or z[1]),
        (x[2] or z[2]) and (not x[2] or y[2]) and (y[2] or z[2]),
        (x[3] or z[3]) and (not x[3] or y[3]) and (y[3] or z[3]),
        (x[4] or z[4]) and (not x[4] or y[4]) and (y[4] or z[4]),
        (x[5] or z[5]) and (not x[5] or y[5]) and (y[5] or z[5]),
        (x[6] or z[6]) and (not x[6] or y[6]) and (y[6] or z[6]),
        (x[7] or z[7]) and (not x[7] or y[7]) and (y[7] or z[7]),
        (x[8] or z[8]) and (not x[8] or y[8]) and (y[8] or z[8]),
        (x[9] or z[9]) and (not x[9] or y[9]) and (y[9] or z[9]),
        (x[10] or z[10]) and (not x[10] or y[10]) and (y[10] or z[10]),
        (x[11] or z[11]) and (not x[11] or y[11]) and (y[11] or z[11]),
        (x[12] or z[12]) and (not x[12] or y[12]) and (y[12] or z[12]),
        (x[13] or z[13]) and (not x[13] or y[13]) and (y[13] or z[13]),
        (x[14] or z[14]) and (not x[14] or y[14]) and (y[14] or z[14]),
        (x[15] or z[15]) and (not x[15] or y[15]) and (y[15] or z[15]),
        (x[16] or z[16]) and (not x[16] or y[16]) and (y[16] or z[16]),
        (x[17] or z[17]) and (not x[17] or y[17]) and (y[17] or z[17]),
        (x[18] or z[18]) and (not x[18] or y[18]) and (y[18] or z[18]),
        (x[19] or z[19]) and (not x[19] or y[19]) and (y[19] or z[19]),
        (x[20] or z[20]) and (not x[20] or y[20]) and (y[20] or z[20]),
        (x[21] or z[21]) and (not x[21] or y[21]) and (y[21] or z[21]),
        (x[22] or z[22]) and (not x[22] or y[22]) and (y[22] or z[22]),
        (x[23] or z[23]) and (not x[23] or y[23]) and (y[23] or z[23]),
        (x[24] or z[24]) and (not x[24] or y[24]) and (y[24] or z[24]),
        (x[25] or z[25]) and (not x[25] or y[25]) and (y[25] or z[25]),
        (x[26] or z[26]) and (not x[26] or y[26]) and (y[26] or z[26]),
        (x[27] or z[27]) and (not x[27] or y[27]) and (y[27] or z[27]),
        (x[28] or z[28]) and (not x[28] or y[28]) and (y[28] or z[28]),
        (x[29] or z[29]) and (not x[29] or y[29]) and (y[29] or z[29]),
        (x[30] or z[30]) and (not x[30] or y[30]) and (y[30] or z[30]),
        (x[31] or z[31]) and (not x[31] or y[31]) and (y[31] or z[31])
    ]

def bool_Maj(x, y, z):
    return [
        (x[0] or y[0]) and (x[0] or z[0]) and (y[0] or z[0]),
        (x[1] or y[1]) and (x[1] or z[1]) and (y[1] or z[1]),
        (x[2] or y[2]) and (x[2] or z[2]) and (y[2] or z[2]),
        (x[3] or y[3]) and (x[3] or z[3]) and (y[3] or z[3]),
        (x[4] or y[4]) and (x[4] or z[4]) and (y[4] or z[4]),
        (x[5] or y[5]) and (x[5] or z[5]) and (y[5] or z[5]),
        (x[6] or y[6]) and (x[6] or z[6]) and (y[6] or z[6]),
        (x[7] or y[7]) and (x[7] or z[7]) and (y[7] or z[7]),
        (x[8] or y[8]) and (x[8] or z[8]) and (y[8] or z[8]),
        (x[9] or y[9]) and (x[9] or z[9]) and (y[9] or z[9]),
        (x[10] or y[10]) and (x[10] or z[10]) and (y[10] or z[10]),
        (x[11] or y[11]) and (x[11] or z[11]) and (y[11] or z[11]),
        (x[12] or y[12]) and (x[12] or z[12]) and (y[12] or z[12]),
        (x[13] or y[13]) and (x[13] or z[13]) and (y[13] or z[13]),
        (x[14] or y[14]) and (x[14] or z[14]) and (y[14] or z[14]),
        (x[15] or y[15]) and (x[15] or z[15]) and (y[15] or z[15]),
        (x[16] or y[16]) and (x[16] or z[16]) and (y[16] or z[16]),
        (x[17] or y[17]) and (x[17] or z[17]) and (y[17] or z[17]),
        (x[18] or y[18]) and (x[18] or z[18]) and (y[18] or z[18]),
        (x[19] or y[19]) and (x[19] or z[19]) and (y[19] or z[19]),
        (x[20] or y[20]) and (x[20] or z[20]) and (y[20] or z[20]),
        (x[21] or y[21]) and (x[21] or z[21]) and (y[21] or z[21]),
        (x[22] or y[22]) and (x[22] or z[22]) and (y[22] or z[22]),
        (x[23] or y[23]) and (x[23] or z[23]) and (y[23] or z[23]),
        (x[24] or y[24]) and (x[24] or z[24]) and (y[24] or z[24]),
        (x[25] or y[25]) and (x[25] or z[25]) and (y[25] or z[25]),
        (x[26] or y[26]) and (x[26] or z[26]) and (y[26] or z[26]),
        (x[27] or y[27]) and (x[27] or z[27]) and (y[27] or z[27]),
        (x[28] or y[28]) and (x[28] or z[28]) and (y[28] or z[28]),
        (x[29] or y[29]) and (x[29] or z[29]) and (y[29] or z[29]),
        (x[30] or y[30]) and (x[30] or z[30]) and (y[30] or z[30]),
        (x[31] or y[31]) and (x[31] or z[31]) and (y[31] or z[31])
    ]
